...
const supabaseAnonKey = import.meta.env?.VITE_SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im1xdW5qdXR1ZnRvdWVveHV5em5uIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjYxNzM1OTAsImV4cCI6MjA4MTc0OTU5MH0.Ux56lyGBlfJMLu61B1Gs6Gz9z50GulPAWWzqcpWMlGg';
    ...
    Tables: {
      users: {
        Row: {
          ...
          role: 'admin' | 'manager' | 'loan_officer' | 'accountant' | 'client';
      ...
      shareholders: {
        ...
        Insert: Omit<Database['public']['Tables']['shareholders']['Row'], 'id' | 'created_at' | 'updated_at'>;
      ...
      funding_transactions: {
        ...
        Insert: Omit<Database['public']['Tables']['funding_transactions']['Row'], 'id' | 'created_at' | 'updated_at'>;
