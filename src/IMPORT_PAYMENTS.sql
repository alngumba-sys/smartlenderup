-- ==========================================
-- IMPORT PAYMENT RECORDS FOR HISTORICAL LOANS
-- SmartLenderUp - Kenya
-- ==========================================
-- This adds payment records for the 10 closed loans from IMPORT_DATA_READY.sql
-- Total Collections: KSh 540,000 (10 loans × 55,000 each)

-- Insert payments into repayments table
...
-- ==========================================
-- These represent the 'amount_paid' values for overdue loans
