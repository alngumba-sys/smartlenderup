-- ============================================
-- ABSOLUTE FINAL FIX - Works with any column names
-- ============================================
-- This version handles different column name variations
-- and adds columns without complex calculations
-- ============================================
...
-- (Set to principal_amount for now - app will calculate)
-- ============================================

-- For active/disbursed loans, set outstanding to principal amount
-- The app will recalculate based on actual repayments
UPDATE public.loans 
...
RAISE NOTICE '✅ Step 6: Outstanding principal initialized for all loans';
...
RAISE NOTICE '✅ Step 7: RLS re-enabled with clean policies';
...
RAISE NOTICE '✅ Step 8: Database indexes created';
