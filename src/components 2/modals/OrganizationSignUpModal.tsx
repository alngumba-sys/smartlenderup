...
export function OrganizationSignUpModal({ isOpen, onClose, onSignUp, accountType = 'organization' }: OrganizationSignUpModalProps) {
  ...
  if (!areRequiredFieldsFilled()) {
    ...
    // REMOVED: Town/City is now optional, don't add to missing fields
          ...
          <div className="max-w-full mx-auto">
            ...
            <div className="mb-7">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  {/* MOBILE-FRIENDLY: Native HTML5 date input works on all devices */}
                  <input
                    type="date"
                    required
                    ...
                    onChange={(e) => {
                      if (e.target.value) {
                        setDateOfIncorporation(new Date(e.target.value));
                      } else {
            ...
            <div className="mb-8 pb-8" style={{ borderBottom: '1px solid rgba(232, 209, 201, 0.1)' }}>
              ...
              <div className="grid grid-cols-2 gap-5">
                ...
                <div>
                  <label className="block text-sm mb-2" style={{ color: '#e8d1c9' }}>
                    Town/City {/* REMOVED ASTERISK - Town/City is now optional */}
                  </label>
                  {countryLocationData[formData.country]?.hasRegions && 
