              ...
              return (
                ...
                >
                  ...
                  <div className="relative" style={{ zIndex: 10 }}>
                    ...
                    {/* Text Container */}
                    <div
                    style={{ padding: '18px', backgroundColor: 'rgb(232, 209, 201)', borderRadius: '0 0 1rem 1rem', position: 'relative', zIndex: 10 }}
                    onClick={(e) => {
                  ...
                  >
                    ...
                    <p 
                      className="mb-3"
                       style={{ color: '#1a0f0d', fontWeight: 'bold', fontSize: '0.788rem' }}
                    >
                      {platform.tagline}
                    </p>
                    ...
                    <p 
                      ...
                      style={{ color: '#2d1612', fontSize: '0.788rem', zIndex: 10 }}
                    >
