...
// Configuration
const SYNC_ENABLED = true; // Set to false to disable Supabase sync
const SHOW_SYNC_TOASTS = true; // Set to true to see sync notifications

/**
 * Syncs data to Supabase in the background
