-- ============================================================================
-- STEP 2B: INSERT 11 SETTLED LOANS
-- ============================================================================
-- Run this AFTER creating the loan products in step 2a
-- ============================================================================
...
BEGIN
    ...
    IF v_personal_loan_id IS NULL THEN
        RAISE EXCEPTION 'PERSONAL LOAN product not found! Run step2a-create-loan-products.sql first!';
    END IF;
    
    IF v_business_loan_id IS NULL THEN
        RAISE EXCEPTION 'BUSINESS LOAN product not found! Run step2a-create-loan-products.sql first!';
    END IF;
    ...
    IF v_client_id IS NULL THEN
        RAISE EXCEPTION 'Client with ID 11111112 (Josphat Matheka) not found!';
    END IF;
    ...
    IF v_client_id IS NULL THEN
        RAISE EXCEPTION 'Client with ID 11111113 (NATALIA THOMAS) not found!';
    END IF;
    ...
    IF v_client_id IS NULL THEN
        RAISE EXCEPTION 'Client with ID 37109668 (Saumu Ouma) not found!';
    END IF;
    ...
    IF v_client_id IS NULL THEN
        RAISE EXCEPTION 'Client with ID 25225003 (SEBASTIAN PETER) not found!';
    END IF;
    ...
    IF v_client_id IS NULL THEN
        RAISE EXCEPTION 'Client with ID 22000875 (ELIZABETH WAWERU) not found!';
    END IF;
    ...
    IF v_client_id IS NULL THEN
        RAISE EXCEPTION 'Client with ID 25267113 (Eric Muthama) not found!';
    END IF;
    ...
    IF v_client_id IS NULL THEN
        RAISE EXCEPTION 'Client with ID 11111115 (ROONEY MBANI) not found!';
    END IF;
    ...
    IF v_client_id IS NULL THEN
        RAISE EXCEPTION 'Client with ID 11111118 (Ben Mbuvi) not found!';
    END IF;
    ...
    IF v_client_id IS NULL THEN
        RAISE EXCEPTION 'Client with ID 11376836 (Stephen Mulu Nzavi) not found!';
    END IF;
