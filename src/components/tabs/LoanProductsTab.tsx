...
import { Plus, Edit2, X, Package, TrendingUp, DollarSign, Calendar, PercentIcon, Check, AlertCircle, Info, Eye, Power, Trash2 } from 'lucide-react';
...
export function LoanProductsTab() {
  ...
  const getProductMetrics = (productId: string) => {
    ...
    const totalDisbursed = productLoans.reduce((sum, l) => sum + l.principalAmount, 0);
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        >
          ...
          <p className={`text-xl ${isDark ? 'text-white' : 'text-gray-900'}`}>
            {currencyCode} {(loans.reduce((sum, l) => sum + l.principalAmount, 0) / 1000000).toFixed(1)}M
          </p>
                ...
                <div className="p-3 bg-blue-50 dark:bg-blue-900/20 border-b border-blue-100 dark:border-blue-800 p-[12px]">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-blue-900 dark:text-blue-100 text-2xl">{product.interestRate}%</p>
                      <p className="text-blue-700 dark:text-blue-300 text-[10px] mt-0.5">{product.interestType} / {product.repaymentFrequency}</p>
                    </div>
                ...
                <div className="p-3 space-y-2 bg-white dark:bg-gray-800">
                  <div className="grid grid-cols-2 gap-2">
                    <div className="p-1.5 bg-gray-50 dark:bg-gray-700 rounded">
                      ...
                      <p className="text-gray-900 dark:text-white text-xs">{currencyCode} {(product.minAmount / 1000).toFixed(0)}K</p>
                    </div>
                    <div className="p-1.5 bg-gray-50 dark:bg-gray-700 rounded">
                      <p className="text-gray-600 dark:text-gray-400 text-[10px]">Max Amount</p>
                      <p className="text-gray-900 dark:text-white text-xs">{currencyCode} {(product.maxAmount / 1000).toFixed(0)}K</p>
                    </div>
                    <div className="p-1.5 bg-gray-50 dark:bg-gray-700 rounded">
                      <p className="text-gray-600 dark:text-gray-400 text-[10px]">Tenor</p>
                      <p className="text-gray-900 dark:text-white text-xs">{product.minTenor}-{product.maxTenor}m</p>
                    </div>
                    <div className="p-1.5 bg-gray-50 dark:bg-gray-700 rounded">
                  ...
                  <div className="pt-2 border-t border-gray-200 dark:border-gray-700">
                    <div className="space-y-1">
                      ...
                      <div className="flex justify-between text-[11px]">
                        ...
                        <span className="text-gray-900 dark:text-white font-medium">{currencyCode} {(metrics.totalDisbursed / 1000).toFixed(0)}K</span>
                      </div>
                      <div className="flex justify-between text-[11px]">
                        <span className="text-gray-600 dark:text-gray-400">Avg Size:</span>
                        <span className="text-gray-900 dark:text-white font-medium">{currencyCode} {(metrics.avgLoanSize / 1000).toFixed(0)}K</span>
                      </div>
                      <div className="flex justify-between text-[11px]">
