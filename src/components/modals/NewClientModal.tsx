...
import { X, User, Building2, Camera, Plus } from 'lucide-react';
...
export function NewClientModal({ isOpen, onClose, onSubmit }: NewClientModalProps) {
  ...
  const [formData, setFormData] = useState({
    ...
    town: '',
    institutionId: '',
    staffMemberId: '', // Assigned staff member
    occupation: '',
    monthlyIncome: '',
  });
    ...
    <>
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      <select
                        ...
                        className="flex-1 px-3 py-2 border border-gray-300 bg-white text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500"
                      >
                      ...
                      <button
                        ...
                        className="px-3 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg transition-colors flex items-center gap-1"
      ...
      <AddInstitutionModal
        ...
        onSubmit={async (institutionData) => {
          ...
          if (newInstitution && newInstitution.id) {
            setFormData({ ...formData, institutionId: newInstitution.id });
          }
