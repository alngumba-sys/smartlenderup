  ...
  return (
    <div className={`fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[200] p-4 ${isDark ? 'dark' : ''}`}>
      <div className="bg-white dark:bg-gray-800 rounded-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        {/* Header */}
        <div className="sticky top-0 bg-[rgb(208,239,255)] dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600 px-6 py-4 flex items-center justify-between z-10">
          <div>
            <h2 className="text-gray-900 dark:text-white">Add New Borrower</h2>
            <p className="text-gray-600 dark:text-gray-300 text-sm">Create individual or business borrower account</p>
          </div>
