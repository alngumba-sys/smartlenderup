...
export function RiskFactorModal({ isOpen, onClose, riskType }: RiskFactorModalProps) {
  ...
  const riskData = {
    'payment-history': {
      ...
      clients: [
        { id: 'C001', name: 'Grace Wanjiru', location: 'Nairobi', phone: '+254 712 345 001', loanAmount: 50000, daysLate: 45, missedPayments: 3, creditScore: 42 },
        { id: 'C015', name: 'John Kimani', location: 'Kisumu', phone: '+254 712 345 015', loanAmount: 75000, daysLate: 32, missedPayments: 2, creditScore: 48 },
        { id: 'C023', name: 'Lucy Achieng', location: 'Mombasa', phone: '+254 712 345 023', loanAmount: 60000, daysLate: 28, missedPayments: 2, creditScore: 51 },
        { id: 'C032', name: 'Peter Omondi', location: 'Nakuru', phone: '+254 712 345 032', loanAmount: 45000, daysLate: 21, missedPayments: 2, creditScore: 55 },
        { id: 'C041', name: 'Mary Njeri', location: 'Eldoret', phone: '+254 712 345 041', loanAmount: 55000, daysLate: 18, missedPayments: 1, creditScore: 58 },
        { id: 'C048', name: 'James Mwangi', location: 'Nairobi', phone: '+254 712 345 048', loanAmount: 70000, daysLate: 15, missedPayments: 1, creditScore: 60 }
      ],
      recommendations: {
        immediate: [
    ...
    'revenue-decline': {
      ...
      clients: [
        { id: 'C007', name: 'Sarah Muthoni', location: 'Nairobi', phone: '+254 712 345 007', loanAmount: 120000, revenueDrop: '35%', business: 'Retail Shop', creditScore: 52 },
        { id: 'C019', name: 'David Kariuki', location: 'Kisumu', phone: '+254 712 345 019', loanAmount: 95000, revenueDrop: '28%', business: 'Food Vendor', creditScore: 58 },
        { id: 'C028', name: 'Ann Wairimu', location: 'Mombasa', phone: '+254 712 345 028', loanAmount: 85000, revenueDrop: '22%', business: 'Hair Salon', creditScore: 61 }
      ],
      recommendations: {
        immediate: [
    ...
    'economic': {
      ...
      clients: [
        { id: 'C012', name: 'Joseph Mutua', location: 'Nairobi', phone: '+254 712 345 012', loanAmount: 110000, sector: 'Transport', impact: 'High fuel costs', creditScore: 64 },
        { id: 'C037', name: 'Susan Adhiambo', location: 'Nakuru', phone: '+254 712 345 037', loanAmount: 95000, sector: 'Agriculture', impact: 'Input cost inflation', creditScore: 66 }
      ],
      recommendations: {
        immediate: [
    ...
    'multiple-loans': {
      ...
      clients: [
        { id: 'C005', name: 'Patrick Otieno', location: 'Nairobi', phone: '+254 712 345 005', loanAmount: 80000, totalDebt: 'KES 245K', lenders: 4, creditScore: 38 },
        { id: 'C018', name: 'Catherine Nyambura', location: 'Kisumu', phone: '+254 712 345 018', loanAmount: 65000, totalDebt: 'KES 198K', lenders: 3, creditScore: 44 },
        { id: 'C026', name: 'Michael Wekesa', location: 'Eldoret', phone: '+254 712 345 026', loanAmount: 90000, totalDebt: 'KES 312K', lenders: 5, creditScore: 35 },
        { id: 'C043', name: 'Jane Akinyi', location: 'Mombasa', phone: '+254 712 345 043', loanAmount: 70000, totalDebt: 'KES 215K', lenders: 3, creditScore: 41 }
      ],
      recommendations: {
        immediate: [
