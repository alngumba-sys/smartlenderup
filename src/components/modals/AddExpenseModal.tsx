...
export function AddExpenseModal({ onClose }: AddExpenseModalProps) {
  ...
  const handlePayeeChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    setFormData({
      ...formData,
      payeeId,
      category: selectedPayee ? selectedPayee.category : ''
    });
  };
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg text-sm bg-gray-100 dark:bg-gray-600 cursor-not-allowed"
                      readOnly
