        ...
        <div className="p-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-gray-900 text-[24px]">Loan Calculator</h3>
            </div>
          ...
          {loanProducts.length === 0 ? (
            <div className="text-center py-12">
              ...
              <h4 className="text-gray-900 mb-2">No Loan Products Available</h4>
            ...
            <>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="block text-gray-700 text-sm mb-2">Loan Product</label>
                    <select
                      value={product}
                      onChange={(e) => setProduct(e.target.value)}
                      className="w-full px-3 py-2 border border-gray-300 bg-white text-gray-900 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                    >
                      {loanProducts.map(p => (
                    ...
                    <>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="p-3 bg-gray-50 rounded-lg">
                          ...
                          <p className="text-gray-900">{currencyCode} {amountNum.toLocaleString()}</p>
                        </div>
                        <div className="p-3 bg-gray-50 rounded-lg">
                          <p className="text-xs text-gray-600">Total Interest</p>
                          <p className="text-gray-900">{currencyCode} {result.totalInterest.toLocaleString()}</p>
                        </div>
                        <div className="p-3 bg-gray-50 rounded-lg">
                          <p className="text-xs text-gray-600">Total Repayment</p>
                          <p className="text-gray-900">{currencyCode} {result.totalRepayment.toLocaleString()}</p>
                        </div>
                        <div className="p-3 bg-gray-50 rounded-lg">
                          <p className="text-xs text-gray-600">Loan Duration</p>
                          <p className="text-gray-900">{tenorNum} months</p>
                        </div>
                      </div>
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-60">
                  <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl p-6">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h3 className="text-gray-900 text-[20px]">Confirm Loan Application</h3>
                    </div>
                    ...
                    {/* High-Level Summary */}
                    <div className="bg-gradient-to-r from-blue-50 to-emerald-50 rounded-lg border border-blue-200 p-4 mb-4">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                          <p className="text-xs text-gray-600 mb-1">Loan Duration</p>
                          <p className="text-gray-900">{tenorNum} months</p>
                        </div>
                        <div>
                      ...
                      <div className="border-t border-gray-300 mt-4 pt-4">
                        <div className="flex justify-between items-center mb-2">
                          ...
                          <span className="text-blue-900 text-xl">{currencyCode} {result.monthlyPayment.toLocaleString()}</span>
                        </div>
                        <div className="flex justify-between items-center mb-2">
                          <span className="text-gray-700">Total Interest:</span>
                          <span className="text-gray-900">{currencyCode} {result.totalInterest.toLocaleString()}</span>
                        </div>
                        <div className="flex justify-between items-center">
                          <span className="text-gray-700">Total Repayment:</span>
                          <span className="text-gray-900">{currencyCode} {result.totalRepayment.toLocaleString()}</span>
                        </div>
                      </div>
                    </div>
