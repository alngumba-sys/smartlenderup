import { Users, Package, MapPin, FileText, Settings as SettingsIcon, Shield, TrendingUp, Award, Star, Palette, Database } from 'lucide-react';
...
export function AdministrationTab() {
  ...
  const [activeSubTab, setActiveSubTab] = useState<'users' | 'performance' | 'products' | 'settings' | 'theme' | 'backup'>('users');
